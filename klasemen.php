						...
						<?php
				  		...
				  		?>
					    	<tr>
						      	...
						      	<td><?= $key['kebobolan'] ?></td>
						      	<td>
						      		<a href="?hal=edit&id=<?=$key['id']?>" onclick="return confirm('Apakah anda yakin ingin mengubah data ini?')" class="btn btn-primary"> Edit </a>
						      		<a href="?hal=hapus&id=<?=$key['id']?>"  onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')" class="btn btn-danger"> Hapus </a>
						      	</td>
					    	</tr>
					    <?php } ?>
					</table>
